...
from reasons_lib import api, Justification
from reasons_lib.metadata import build_meta, SCHEMA_VERSION
...
class TestBuildMeta:
    ...
    def test_basic_fields(self):
        ...
        assert "ftl-reasons/" in meta["generator"]
...
class TestJsonExportMeta:
    ...
    def test_export_includes_meta(self, tmp_path):
        ...
        assert "ftl-reasons/" in data["meta"]["generator"]
...
class TestMarkdownExportMeta:
    ...
    def test_frontmatter_present(self):
        ...
        assert "generator: ftl-reasons/" in md
